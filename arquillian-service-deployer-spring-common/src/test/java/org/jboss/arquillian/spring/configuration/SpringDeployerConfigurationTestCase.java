...
public class SpringDeployerConfigurationTestCase {
    ...
    /**
     * <p>Tests both {@link SpringDeployerConfiguration#isAutoPackaging()} and {@link
     * SpringDeployerConfiguration#setAutoPackaging(boolean)}  method.</p>
     */
    @Test
    ...
    /**
     * <p>Tests both {@link SpringDeployerConfiguration#isIncludeSnowdrop()} and {@link
     * SpringDeployerConfiguration#setIncludeSnowdrop(boolean)}  method.</p>
     */
    @Test
    ...
    /**
     * <p>Tests both {@link SpringDeployerConfiguration#getSpringVersion()} and {@link
     * SpringDeployerConfiguration#setSpringVersion(String)}  method.</p>
     */
    @Test
    ...
    /**
     * <p>Tests both {@link SpringDeployerConfiguration#getSpringVersion()} and {@link
     * SpringDeployerConfiguration#setCglibVersion(String)} method.</p>
     */
    @Test
    ...
    /**
     * <p>Tests both {@link SpringDeployerConfiguration#getSnowdropVersion()} and {@link
     * SpringDeployerConfiguration#setSnowdropVersion(String)} method.</p>
     */
    @Test
