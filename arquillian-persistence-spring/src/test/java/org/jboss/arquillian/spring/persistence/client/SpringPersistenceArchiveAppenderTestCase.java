...
/**
 * <p>Tests {@link SpringPersistenceArchiveAppender} class.</p>
 *
...
public class SpringPersistenceArchiveAppenderTestCase {
     ...
     */
    private final static List<Class<?>> REQUIRED_CLASSES =
            Arrays.<Class<?>>asList(ApplicationContextDataSourceProvider.class, SpringPersistenceRemoteExtension.class);
    ...
    public void setUp() {
        ...
        instance = new SpringPersistenceArchiveAppender();
    }

    /**
     * <p>Tests the {@link SpringPersistenceArchiveAppender#createAuxiliaryArchive()} method.</p>
     *
