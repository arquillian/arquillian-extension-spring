...
/**
 * <p>The producer that creates the {@link SpringExtensionRemoteConfiguration} loaded from properties files.</p>
 *
...
public class SpringExtensionRemoteConfigurationProducer {
    ...
    /**
     * <p>Producer proxy for {@link SpringExtensionRemoteConfiguration}.</p>
     */
    @Inject
    @ApplicationScoped
    ...
    private SpringExtensionRemoteConfiguration loadConfigurationFromProperties() {
        ...
        return SpringExtensionRemoteConfigurationUtils.loadResource(
                SecurityActions.getResource(SpringExtensionRemoteConfigurationUtils.SPRING_REMOTE_PROPERTIES));
    }
}
