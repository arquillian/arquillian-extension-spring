 ...
 */
@SpringAnnotationConfiguration(classes = {TestConfig.class}, contextClass = AnnotationConfigApplicationContext.class)
public class AnnotatedClassesCustomContextClass {
}
