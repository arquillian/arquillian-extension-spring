...
/**
 * <p>Tests {@link ErrorsProvider} class.</p>
 *
 * @author <a href="mailto:jmnarloch@gmail.com">Jakub Narloch</a>
 */
@RunWith(MockitoJUnitRunner.class)
public class ErrorsProviderTestCase extends ProviderBaseTestCase {
    ...
    /**
     * <p>Tests the {@link ErrorsProvider#canProvide(Class)} method.</p>
     */
    @Test
    public void testCanProvide() {

        assertTrue("The provider class does not support required type.", instance.canProvide(Errors.class));
    }

    /**
     * <p>Tests the {@link ErrorsProvider#canProvide(Class)} method when the supported class is not supported.</p>
     */
    @Test
