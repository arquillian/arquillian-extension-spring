...
/**
 * <p>Tests {@link HandlerProvider} class.</p>
 *
 * @author <a href="mailto:jmnarloch@gmail.com">Jakub Narloch</a>
 */
@RunWith(MockitoJUnitRunner.class)
public class HandlerProviderTestCase extends ProviderBaseTestCase {
    ...
    public void setUp() throws Exception {
        ...
        initProvider(new HandlerProvider());
    }

    /**
     * <p>Tests the {@link HandlerProvider#canProvide(Class)} method.</p>
     */
    @Test
    public void testCanProvide() {

        assertTrue("The provider class does not support required type.", instance.canProvide(Object.class));
    }

    /**
     * <p>Tests the {@link HandlerProvider#canProvide(Class)} method when the supported class is not supported.</p>
     */
    @Test
    ...
    /**
     * <p>Tests the {@link HandlerProvider#canProvide(Class)} method when the provided resource is null.</p>
     */
    @Test
    public void testCanProvideResourceNull() {

        springMvcResult.setHandler(null);

        assertFalse("The provider incorrectly handles null values.", instance.canProvide(Object.class));
    }

    /**
     * <p>Tests {@link HandlerProvider#lookup(ArquillianResource, java.lang.annotation.Annotation...)} method.</p>
     */
    @Test
