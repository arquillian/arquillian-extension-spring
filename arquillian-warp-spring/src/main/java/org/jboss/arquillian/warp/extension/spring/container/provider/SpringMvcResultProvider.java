...
/**
 * <p>A resource provider that supplies the {@link SpringMvcResult} instance.</p>
 *
...
public class SpringMvcResultProvider extends AbstractWarpGenericResourceProvider<SpringMvcResult> {
     ...
     */
    @Override
    protected SpringMvcResult internalLookup(ArquillianResource resource, Annotation... qualifiers) {
