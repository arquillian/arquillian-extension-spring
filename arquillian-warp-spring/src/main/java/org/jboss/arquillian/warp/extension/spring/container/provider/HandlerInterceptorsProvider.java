...
/**
 * <p>A resource provider that supplies the {@link HandlerInterceptor} array.</p>
 *
...
public class HandlerInterceptorsProvider extends AbstractWarpResourceProvider<HandlerInterceptor[]> {
     ...
     */
    @Override
    protected HandlerInterceptor[] internalLookup(ArquillianResource resource, Annotation... qualifiers) {
