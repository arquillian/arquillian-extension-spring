...
/**
 * <p>A resource provider that supplies the {@link Errors} instance.</p>
 *
...
public class ErrorsProvider extends AbstractWarpGenericResourceProvider<Errors> {
    ...
    public boolean canProvide(Class<?> aClass) {
        ...
        return getProvidedResourceClass().equals(aClass)
                && getSpringMvcResult().getErrors() != null;
    }
     ...
     */
    @Override
    protected Errors internalLookup(ArquillianResource resource, Annotation... qualifiers) {
