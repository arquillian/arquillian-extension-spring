...
/**
 * <p>A resource provider that supplies the {@link ModelAndView} instance.</p>
 *
...
public class ModelAndViewProvider extends AbstractWarpGenericResourceProvider<ModelAndView> {
    ...
    public boolean canProvide(Class<?> aClass) {
        ...
        return getProvidedResourceClass().equals(aClass)
                && getSpringMvcResult().getModelAndView() != null;
    }
     ...
     */
    @Override
    protected ModelAndView internalLookup(ArquillianResource resource, Annotation... qualifiers) {
