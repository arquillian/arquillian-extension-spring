...
public class SpringEmbeddedApplicationContextProducerTestCase {
    ...
    /**
     * <p>Represents an instance of {@link ApplicationContextProducer} that will always support the test class.</p>
     */
    private ApplicationContextProducer supportedApplicationContextProducer;

    /**
     * <p>Represents an instance of {@link ApplicationContextProducer} that will never support the test class.</p>
     */
    private ApplicationContextProducer notSupportedApplicationContextProducer;
    ...
    public void setUp() {
        ...
        supportedApplicationContextProducer = mock(ApplicationContextProducer.class);
        ...
        notSupportedApplicationContextProducer = mock(ApplicationContextProducer.class);
    ...
    public void testInitApplicationContextSupported() throws Exception {
        ...
        List<ApplicationContextProducer> producers = new ArrayList<ApplicationContextProducer>();
        ...
        when(serviceLoader.all(ApplicationContextProducer.class)).thenReturn(producers);
